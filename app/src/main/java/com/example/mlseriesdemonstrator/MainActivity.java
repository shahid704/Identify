...
import com.example.mlseriesdemonstrator.image.OCR;
import com.example.mlseriesdemonstrator.image.ScanCode;
...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Algo(R.drawable.ic_image_folder_rafiki, "Image Classification", ImageClassificationActivity.class));
        arrayList.add(new Algo(R.drawable.ic_flower, "Flower Identification", FlowerIdentificationActivity.class));
        arrayList.add(new Algo(R.drawable.ic_analyze_cuate, "Object Detection", ObjectDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.ic_face_mask_emoji_bro, "Face Detection", FaceDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.ic_mic_drop_bro, "Audio Classification", AudioClassificationActivity.class));
        arrayList.add(new Algo(R.drawable.ic_tropical_birds_cuate, "Bird Sound Identifier", BirdSoundDetectorActivity.class));
       // arrayList.add(new Algo(R.drawable.baseline_comment_black_48, "Spam Text Detector", SpamTextDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.ic_car_crash_amico, "Driver Drowsiness Detector", DriverDrowsinessDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.ic_search_rafiki, "Pose Detection", PoseDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.ic_my_answer_amico, "Text Scan", OCR.class));
        arrayList.add(new Algo(R.drawable.animated_scan, "Barcode Scan", ScanCode.class));
